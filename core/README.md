...
[trunk:mycarrier]
address = udp://sip.example.com:5060
username = myuser
password = mypass
did = 15559876543
# did = 15551234567
...
| Option | Description |
|--------|-------------|
| `address` | Upstream SIP server address in URL format: `udp://hostname[:port]`. Port defaults to 5060 if omitted. Currently only UDP transport is supported. |
